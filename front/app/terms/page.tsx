    ...
    <LegalShell title="이용약관" updatedAt="2026-07-31">
      ...
      <Article heading="제4조 (서비스의 내용 및 상품)">
        ...
        <ul className="list-disc pl-5">
          ...
          <li>건별 서비스(단건 결제): 무료형에서 PPWR AI 진단·TD 작성·DoC 발행 등 필요한 서비스를 건별 단가로 결제하는 1회성 이용.</li>
          <li>미구독 고객 패키지(단건 결제): 등록 대행·문서 발행·EPR 기초자료 등을 묶어 제공하는 1회성 패키지.</li>
        </ul>
        <p>정확한 상품 구성 및 가격은{" "}
      ...
      <Article heading="제5조 (결제 수단 및 정기결제)">
        <p>
